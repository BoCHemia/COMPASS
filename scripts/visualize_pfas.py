# This script was used to explore PFAS, I left the script here for the record.
# Data / methods might be outdated.
...
reference_file = 'pfas_nist_partial'
...
figure = map_input_data(figure, new_coordinates, nametag=input_file,
                        hover_name='PREFERRED_NAME', hover_data=['INCHIKEY', 'SMILES'], opacity=1)
figure = map_input_data(figure, new_coordinates, nametag=input_file,
...
new_coordinates_2 = load_coordinates(folder_name=input_folder, file_name=input_file_2, reference_data=reference_file)
